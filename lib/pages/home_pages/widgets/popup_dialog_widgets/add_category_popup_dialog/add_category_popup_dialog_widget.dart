...
import 'package:uptodo/pages/home_pages/widgets/popup_dialog_widgets/add_category_popup_dialog/items/color_select_widget.dart';
import 'package:uptodo/pages/home_pages/widgets/popup_dialog_widgets/add_category_popup_dialog/items/icon_select_widget.dart';
                      ...
                      (() {
                        if (categoryName.isNotEmpty) {
                          CategoryModel categoryModelNew = CategoryModel(
                              ...
                              selectedColorIndex,
                              selectedIconIndex);
                          categoryCreated(categoryModelNew);
                          Navigator.pop(context);
                        } else {
